...
*/
let cityName = 'Chercassy'
let countryName = 'Ukraine'
let countPeople = 35000000
let footcallStadion = true
...
let g = (speedOfFirst * time) + (speedOfSecond + time)
console.log(g)
/* 
    Задание 4:
...
*/
switch(randomNumber) {
    case 20 : console.log("randomNumber меньше 20")
    break
    case 50 : console.log("randomNumber больше 50")
    break
